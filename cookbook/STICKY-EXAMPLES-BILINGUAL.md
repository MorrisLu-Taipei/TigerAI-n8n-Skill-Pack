...
> 🌐 [English](STICKY-EXAMPLES-BILINGUAL.en.md) | **繁體中文**

> 8 個 cookbook 範例的便利貼內容，**中英文並列**。挑你團隊熟的語言整段貼進 n8n 黃色便利貼。
>
> AI 兩種語言都認，產出的 workflow 完全等價。

---

## 怎麼用這份表

1. 找到你要的場景（編號對應 [`00-INDEX.md`](00-INDEX.md)）
2. 從**繁體中文**或 **English** 任選一欄整段複製
3. 貼進 n8n 畫布的黃色便利貼
4. 呼叫 AI → 自動產出完整 workflow
...
每個範例的 DSL 版本是**語言中立**的（用 `@trigger:` `@step:` 等英文標籤 + 任意語言內容），AI 同樣兩種都認。詳見各 cookbook 頁的「📐 進階：DSL 嚴謹寫法」折疊區。
...
| 你的團隊情境 | 建議用 |
|---|---|
| 全中文團隊 | 中文版便利貼 + 中文 AI 對話 |
| 全英文 / 國際團隊 | English 便利貼 + English AI 對話 |
| 中英混合 / 跨國 | **建議統一英文版**（國際團隊都看得懂；AI 處理一致性也最高） |
| 給未來接手者 | 任選；但同一 workflow 內的便利貼建議只用一種語言（避免歧義） |
